...
--
-- Host: 127.0.0.1
-- Generation Time: Apr 06, 2020 at 07:33 AM
...
INSERT INTO `book` (`book_ID`, `book_Date`, `student_ID`, `tutor_ID`, `subject_ID`) VALUES
(1, '2019-09-25', 2, 1, 1),
(2, '2019-09-17', 1, 2, 2),
(3, '2019-09-18', 1, 1, 1),
(5, '2019-09-28', 3, 1, 3),
...
(3, 'online', 'albion', 120, 6),
(4, 'onsite', 'clayfield', 130, 10),
(5, 'onsite', 'chermside', 100, 11),
(6, 'online', 'milton', 150, 12);
...
(4, 'Harry', 'Qi', '$2y$10$fKCOP39BUd46C4Xm49iInO7ijJZHfElCPQIs0iMrEPy5IVwJTFvaK', 'harry@gmail.com', 1, 324321421, 'male', 24, '2001-09-25', 'Cash', 'harry123.jpg', 'harry1', ''),
...
(6, 'vijay', 'kunwar', '$2y$10$fKCOP39BUd46C4Xm49iInO7ijJZHfElCPQIs0iMrEPy5IVwJTFvaK', 'kunwar.vijaya@gmail.com', 1, 422033078, 'Male', 0, '1999-10-24', '', 'tutor6.jpg', 'vijaytutor', ''),
...
(11, 'tutor', 'two', '$2y$10$T1vuwIVJcU4L5rw.XKhPfuaMC/z7wW4./5oS1aTg6OPJWt.5a7hGm', 'tutor.two@gmail.com', 1, 1234567891, 'Male', 0, '1998-04-02', '', 'tutor11.jpjg', 'Tutor2', ''),
...
--
ALTER TABLE `book`
  ADD CONSTRAINT `book_ibfk_1` FOREIGN KEY (`student_ID`) REFERENCES `student` (`student_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `book_ibfk_2` FOREIGN KEY (`tutor_ID`) REFERENCES `tutor` (`tutor_ID`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `book_ibfk_3` FOREIGN KEY (`subject_ID`) REFERENCES `subject` (`subject_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
...
--
ALTER TABLE `subject`
  ADD CONSTRAINT `subject_ibfk_1` FOREIGN KEY (`tutor_ID`) REFERENCES `tutor` (`tutor_ID`) ON DELETE CASCADE ON UPDATE CASCADE;
